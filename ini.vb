...
Public Class IniFile
    ...
    Public Sub Load(ByVal sFileName As String, Optional ByVal bMerge As Boolean = False)
        ...
        If Not File.Exists(sFileName) Then
        	MessageBox.Show("Config-File was not found, please redownload JD-Headless!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1)
        	end
        End If
